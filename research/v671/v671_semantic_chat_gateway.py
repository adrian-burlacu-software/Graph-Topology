...
from v671_semantic_core import (
    Graph,
    DistilledMemory,
    candidate_senses,
    Context,
...
from v671_memory import RamSemanticMemory, SharedCheckpoint, SharedDistilledMemory
...
def run_chat_worker(args):
    ...
    ap.add_argument(
        "--shared-memory",
        required=False,
        default="./results/v671_shared_memory.sqlite",
    )
    ap.add_argument(
        "--worker-id",
        type=int,
    ...
    try:
        ...
        pass
    distilled = SharedDistilledMemory(graph, ram_memory)
        ...
        while not sync_stop.wait(0.50):
            try:
                ...
                try:
                    ...
                    pass
    sync_thread = threading.Thread(target=_sync_loop, name="v671-chat-checkpoint", daemon=True)
    sync_thread.start()
