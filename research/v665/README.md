...
```powershell
python .\research\v665\v665_semantic_chat_gateway.py --database ".\data\v633_full_semantic.sqlite" --output ".\results\v665_chat.json" --trace-output ".\results\v665_chat_traces.jsonl" --memory-output ".\results\v665_memory.json" --spacy-model en_core_web_sm --llm-model "C:\Users\adria\Desktop\dev\Graph-Topology\llm\SmolLM3-3B" --mode chat --max-hypotheses 12 --relation-vocabulary 64 --goal-budget 40 --budget 80 --per-node 60 --max-depth 3 --cache-entries 12000 --prior-decay 0.65 --seed 66500 --progress-every 1
```
