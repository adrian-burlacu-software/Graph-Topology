...
def main():
    ...
    print()
    print("V481 modular cognitive assistant ready.")
    print(
        "Architecture owns goal, memory, retrieval, evaluation and choice."
    )
    print(
        "LLM is an internal participant/realizer; it is not the final authority."
    )
