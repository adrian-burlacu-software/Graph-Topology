...
class CognitiveAssistant:
    ...
    def _clean_participant_output(self,text):
        if not text:
            return None
        ...
        meta_prefixes=(
            ...
            "a useful candidate proposition or conversational move for the architecture to evaluate is:",
        )
    ...
    def respond(self,text):
        ...
        if self.participant:
            ...
            raw_participant=self.participant.propose(
                goal,
                text,
                context,
                memory_facts,
            ...
            participant_content=self._clean_participant_output(
                raw_participant
            )
            ...
            if raw_participant!=participant_content:
                print(
                    "  [ARCHITECTURE] participant_meta_filtered=True",
                    flush=True,
                )
        else:
        ...
        # The LLM may surface the chosen architectural content naturally,
        # but selection has already happened.
        selected_content=winner.content
        ...
        print(
            ...
            f"selected_content={winner.content!r}",
            flush=True,
        )
        print(
