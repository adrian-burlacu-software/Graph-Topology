...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v266"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v266_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V266 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v266_summary.json"
    summary.write_text(
