...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v285"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v285_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V285 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v285_summary.json"
    summary.write_text(
