...
class DualVocabularyV6:
    ...
    def designer_action(self, available, learn):
        ...
        # V6: each boundary is an independent competition.
    ...
    def reset_designer_transient_state(self):
        """
        Clear only per-decision electrical state.

        Learned weights, synapses, topology, and long-term counters stay
        intact. This makes every boundary decision a fresh competition
        between REUSE and BRANCH while preserving learning across the run.
        """
        n = self.net

        for cid in (n.designer_root, n.reuse_cell, n.branch_cell):
            cell = n.cells[cid]
            cell.potential = 0.0
            cell.inhibition = 0.0
    ...
    def evaluate_frozen(self, words):
        ...
        print()
        print("=== PER-BOUNDARY RESET ===")
        print("Transient designer potential/inhibition is cleared before each boundary.")
        print("Learned weights and topology are preserved.")
