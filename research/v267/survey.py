...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v267"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v267_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V267 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v267_summary.json"
    summary.write_text(
