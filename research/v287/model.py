...
class StateArchitectureModel(nn.Module):
    ...
    def __init__(
        ...
        # V287: protected persistent workspace.
        ...
        # V287: explicit persistent-memory read path.
        ...
        # V287: action-specific memory binding. The remembered workspace is
    ...
    def cognitive_step(
        ...
        # V287 explicit memory read path.
