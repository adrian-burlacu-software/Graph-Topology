...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v287"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v287_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V287 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v287_summary.json"
    summary.write_text(
