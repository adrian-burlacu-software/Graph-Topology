...
from structured_memory import CONFIGS
...
def main():
    ...
    payload={
        "version":"v314",
        "benchmark":"structured_working_memory",
        "tasks":list(TASKS),
        "seeds":seeds,
    ...
    print("=== V314 STRUCTURED WORKING MEMORY ===")
    print(
