...
from v679_offline_learning import GENERAL_LANES, worker_main
from v679_worker_summary import worker_summary
...
def run_configuration(args, worker_count, root):
    ...
    processes = [
        mp.Process(
            ...
            name=f"v679-benchmark-{worker_id:02d}",
        )
...
def main():
    parser = argparse.ArgumentParser(
        description="Benchmark V679 general-lane worker-pool sizes on this machine."
    )
    parser.add_argument("--database", required=True)
    parser.add_argument("--output", default="./results/v679/worker_pool_benchmark.jsonl")
    ...
    parser.add_argument("--seed", type=int, default=67900)
