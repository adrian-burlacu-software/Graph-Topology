...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v283"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v283_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V283 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v283_summary.json"
    summary.write_text(
