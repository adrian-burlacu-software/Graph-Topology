...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v288"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v288_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V288 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v288_summary.json"
    summary.write_text(
