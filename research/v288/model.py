...
class StateArchitectureModel(nn.Module):
    ...
    def __init__(
        ...
        # V288: protected persistent workspace.
        ...
        # V288: explicit persistent-memory read path.
        ...
        # V288: action-specific memory binding. The remembered workspace is
    ...
    def cognitive_step(
        ...
        # V288 explicit memory read path.
