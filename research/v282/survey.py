...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v282"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v282_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V282 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v282_summary.json"
    summary.write_text(
