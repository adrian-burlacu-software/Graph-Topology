...
from v645_semantic_core import (
    Graph,
    DistilledMemory,
    candidate_senses,
    Context,
...
class Realizer:
    ...
    def grounded_prompt(self, question, hypothesis, result, definition=None):
        evidence = " -> ".join(result.get("path", []))
        relation_wording = {
