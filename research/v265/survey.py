...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v265"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v265_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V265 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v265_summary.json"
    summary.write_text(
