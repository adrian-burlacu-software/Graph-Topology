...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v270"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v270_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V270 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v270_summary.json"
    summary.write_text(
