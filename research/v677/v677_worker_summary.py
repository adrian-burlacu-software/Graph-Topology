...
def main():
    parser = argparse.ArgumentParser(
        description="Write a compact V677 overnight-run worker/checkpoint summary."
    )
    parser.add_argument("--worker-log-dir", default="./results/v677_workers")
    parser.add_argument("--shared-memory", default="./results/v677_shared_memory.sqlite")
    parser.add_argument("--output", default="./results/v677/worker_summary.jsonl")
