...
def main():
    ...
    p.add_argument("--output-dir",type=Path,default=Path("results/v277"))
    p.add_argument("--dataset-output",type=Path,default=Path("results/v277_counterfactual_dataset.jsonl"))
    args=p.parse_args()
    ...
    print(
        "=== V277 COMPACT CAUSAL ARCHITECTURE BENCHMARK ===",
        flush=True,
    )
    ...
    summary=output_dir/"v277_summary.json"
    summary.write_text(
